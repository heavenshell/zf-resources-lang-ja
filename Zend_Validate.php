...
return array(
    // Zend_Validate_Alnum
    "Invalid type given, value should be float, string, or integer" => "不正な形式です。小数、文字列もしくは数値を入力して下さい",
    ...
    "Luhn algorithm (mod-10 checksum) failed on '%value%'" => "'%value%'はルーンアルゴリズム(mod-10 チェックサム)に失敗しました",

    // Zend_Validate_CreditCard
    "Luhn algorithm (mod-10 checksum) failed on '%value%'" => "'%value%'はルーンアルゴリズム(mod-10 チェックサム)に失敗しました",
    "'%value%' must contain only digits" => "'%value%'は数値だけで構成される必要があります",
    "Invalid type given, value should be a string" => "不正な形式です。値は文字列を入力して下さい",
    "'%value%' contains an invalid amount of digits" => "'%value%'は不正な桁数です",
    "'%value%' is not from an allowed institute" => "'%value%'は認可機関から許可されていません",
    "Validation of '%value%' has been failed by the service" => "'%value%'の検証はサービスより失敗が応答しました。",
    ...
    "All files in sum should have a maximum size of '%max%' but '%size%' were detected" => "全てのファイルの合計は最大'%max%'より小さい必要がります。ファイルサイズは'%size%'でした",
    "All files in sum should have a minimum size of '%min%' but '%size%' were detected" => "全てのファイルの合計は最小'%min%'より大きい必要があります。ファイルサイズは'%size%'でした",
    ...
    "File '%value%' can not be read" => "画像'%value%'を読み込めませんでした",
    ...
    "The mimetype of file '%value%' could not be detected" => "Mimetype '%value%'のファイルは見つかりませんでした",
    "File '%value%' can not be read" => "ファイル'%value%'は読み込めませんでした",

    // Zend_Validate_File_Md5
    "File '%value%' does not match the given md5 hashes" => "ファイル'%value%'は md5 ハッシュ値と一致していません",
    "A md5 hash could not be evaluated for the given file" => "渡されたファイルは md5 ハッシュ値として評価できませんでした",
    "File '%value%' could not be found" => "ファイル'%value%'は見つかりませんでした",
    ...
    "A sha1 hash could not be evaluated for the given file" => "渡されたファイルは sha1 ハッシュ値として評価できませんでした",
    "File '%value%' could not be found" => "ファイル'%value%'は見つかりませんでした",

    // Zend_Validate_File_Size
    "Maximum allowed size for file '%value%' is '%max%' but '%size%' detected" => "ファイルサイズは'%size%'です。ファイル'%value%'は最大'%max%'まで許されています",
    "Minimum expected size for file '%value%' is '%min%' but '%size%' detected" => "ファイルサイズは'%size%'です。ファイル'%value%'の最小'%min%'以上必要です",
    "File '%value%' could not be found" => "ファイル'%value%'は見つかりませんでした",

    // Zend_Validate_File_Upload
    "File '%value%' exceeds the defined ini size" => "ファイル'%value%'は ini で定義された値を超えています",
    "File '%value%' exceeds the defined form size" => "ファイル'%value%'はフォームで定義された値を超えています",
    ...
    "No temporary directory was found for file '%value%'" => "ファイル'%value%'をアップロードするテンポラリディレクトリが見つかりませんでした",
